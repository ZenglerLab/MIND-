...
## Community 1: Full community (Supp. Fig. S1 a)
...
### Abundance plot averages (Figure 2 b)
...
More diversity, slow grtowers had time to grow. 
...
Is overall transcriptional and translational activity of competitors increased as well as metagenomics abundance?

### Subset of figure 2 e

```{r, fig.width=3, fig.height = 2.5}
bur_metaT <- ggplot(test[test$Group.1 != "Burkholderia", ], aes(x = X1_av_T2_metaT, y = X4_av_T2_metaT)) +
  geom_point(aes(color = Group.1), size = 3) +
  scale_x_sqrt() +
  scale_y_sqrt() +
  scale_color_manual(values = vec_col5) +
  ...
  ylab(expression(paste("", italic("- Burkholderia"), " (RPKM)"))) +  
      theme(legend.position = "none", panel.background = element_rect(fill = "white"), panel.grid.major = element_line(colour = "gray92"), panel.grid.minor = element_line(colour = "gray95"))  +
    theme(axis.text=element_text(size=8), axis.title=element_text(size=11)) +
  geom_point(aes(x = test[test$Group.1 == "Burkholderia", ]$X1_av_T2_metaT, y = test[test$Group.1 == "Burkholderia", ]$X4_av_T2_metaT), color = "dodgerblue", shape = 8, size = 2.5)

bur_metaT


lys_metaT <- ggplot(test[test$Group.1 != "Lysobacter", ], aes(x = X1_av_T2_metaT, y = X2_av_T2_metaT)) +
  geom_point(aes(color = Group.1), size = 3) +
  scale_x_sqrt() +
  scale_y_sqrt() +
  scale_color_manual(values = vec_col3) +
  ...
  xlab("SynCom (RPKM)") +
  ylab(expression(paste("", italic("- Lysobacter"), " (RPKM)"))) +  
  geom_point(aes(x = test[test$Group.1 == "Lysobacter", ]$X1_av_T2_metaT, y = test[test$Group.1 == "Lysobacter", ]$X2_av_T2_metaT), color = "midnightblue", shape = 8, size = 2.5) +
      theme(legend.position = "none", panel.background = element_rect(fill = "white"), panel.grid.major = element_line(colour = "gray92"), panel.grid.minor = element_line(colour = "gray95"))  +
    theme(axis.text=element_text(size=8), axis.title=element_text(size=11)) +   theme(axis.text.x = element_text(angle = 45, hjust=1))
...
muci_metaT <- ggplot(test[test$Group.1 != "Mucilaginibacter", ], aes(x = X1_av_T2_metaT, y = X3_av_T2_metaT)) +
  geom_point(aes(color = Group.1), size = 3) +
  scale_x_sqrt() +
  scale_y_sqrt() +
  scale_color_manual(values = vec_col4) +
  ...
  xlab("SynCom (RPKM)") +
  ylab(expression(paste("", italic("- Mucilaginibacter"), " (RPKM)"))) +  
  geom_point(aes(x = test[test$Group.1 == "Mucilaginibacter", ]$X1_av_T2_metaT, y = test[test$Group.1 == "Mucilaginibacter", ]$X3_av_T2_metaT), color = "darkorange2", fill = "darkorange2", shape = 8, size = 2.5)  +
      theme(legend.position = "none", panel.background = element_rect(fill = "white"), panel.grid.major = element_line(colour = "gray92"), panel.grid.minor = element_line(colour = "gray95"))  +
    theme(axis.text=element_text(size=8), axis.title=element_text(size=11)) +   theme(axis.text.x = element_text(angle = 45, hjust=1))
...
```{r, fig.width=3, fig.height = 2.5}
bur_metaRS <- ggplot(test[test$Group.1 != "Burkholderia", ], aes(x = X1_av_T2_metaRS, y = X4_av_T2_metaRS)) +
  geom_point(aes(color = Group.1), size = 3) +
  scale_x_sqrt() +
  scale_y_sqrt() +
  scale_color_manual(values = vec_col5) +
  ...
  ylab(expression(paste("", italic("- Burkholderia"), " (RPKM)"))) +  
      theme(legend.position = "none", panel.background = element_rect(fill = "white"), panel.grid.major = element_line(colour = "gray92"), panel.grid.minor = element_line(colour = "gray95"))  +
    theme(axis.text=element_text(size=8), axis.title=element_text(size=11)) +
  geom_point(aes(x = test[test$Group.1 == "Burkholderia", ]$X1_av_T2_metaRS, y = test[test$Group.1 == "Burkholderia", ]$X4_av_T2_metaRS), color = "dodgerblue", shape = 8, size = 2.5)

bur_metaRS


lys_metaRS <- ggplot(test[test$Group.1 != "Lysobacter", ], aes(x = X1_av_T2_metaRS, y = X2_av_T2_metaRS)) +
  geom_point(aes(color = Group.1), size = 3) +
  scale_x_sqrt() +
  scale_y_sqrt() +
  scale_color_manual(values = vec_col3) +
  ...
  xlab("SynCom (RPKM)") +
  ylab(expression(paste("", italic("- Lysobacter"), " (RPKM)"))) +  
  geom_point(aes(x = test[test$Group.1 == "Lysobacter", ]$X1_av_T2_metaRS, y = test[test$Group.1 == "Lysobacter", ]$X2_av_T2_metaRS), color = "midnightblue", shape = 8, size = 2.5) +
      theme(legend.position = "none", panel.background = element_rect(fill = "white"), panel.grid.major = element_line(colour = "gray92"), panel.grid.minor = element_line(colour = "gray95"))  +
    theme(axis.text=element_text(size=8), axis.title=element_text(size=11)) +   theme(axis.text.x = element_text(angle = 45, hjust=1))
...
muci_metaRS <- ggplot(test[test$Group.1 != "Mucilaginibacter", ], aes(x = X1_av_T2_metaRS, y = X3_av_T2_metaRS)) +
  geom_point(aes(color = Group.1), size = 3) +
  scale_x_sqrt() +
  scale_y_sqrt() +
  scale_color_manual(values = vec_col4) +
  ...
  xlab("SynCom (RPKM)") +
  ylab(expression(paste("", italic("- Mucilaginibacter"), " (RPKM)"))) +  
  geom_point(aes(x = test[test$Group.1 == "Mucilaginibacter", ]$X1_av_T2_metaRS, y = test[test$Group.1 == "Mucilaginibacter", ]$X3_av_T2_metaRS), color = "darkorange2", fill = "darkorange2", shape = 8, size = 2.5)  +
      theme(legend.position = "none", panel.background = element_rect(fill = "white"), panel.grid.major = element_line(colour = "gray92"), panel.grid.minor = element_line(colour = "gray95"))  +
    theme(axis.text=element_text(size=8), axis.title=element_text(size=11)) +   theme(axis.text.x = element_text(angle = 45, hjust=1))
...
dropout_multiomics <- plot_grid(bur, bur_metaT, bur_metaRS, 
                                muci, muci_metaT, muci_metaRS, 
                                lys, lys_metaT, lys_metaRS,
                         ncol = 3, 
                         align = "hv")
...
# ggsave(file="dropout_multiomics.png", plot=dropout_multiomics, height = 7, width = 8, dpi = 600)
...
After running scripts 4. ad 5., one can run the following command to get Figure 2e:
