...
## Discard bad sample: 1_2_T2_metaG
...
metaRS reads are very short, so they are prone to false hits in alignment. To remove this noise, we filter out metaRS reads that were not detected in metaT data.  
...
_Terrabacter_ and _Bacillus_ are present in the genome database, but absent from the SynCom. They should have the lowest read number in the community (noise only).  
