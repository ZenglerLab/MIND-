...
data <- fread("./data/counts_genus_uniref.tsv",
            sep="\t",
            dec=".",
            header = TRUE,
...
barplot(colSums(data_cpm[, 3:ncol(data_cpm)]))
```
...
write.csv(pt_fructose$res, "./out/tables/genus_uniref_fructose.csv")

# xylose
#pt_xylose <- primary_targets("T1", 10, 'ylose', 'zzz')
pt_xylose <- primary_targets("T1", 0, 'ylose', 'zzz')
write.csv(pt_xylose$res, "./out/tables/genus_uniref_xylose.csv")
...
# B12
pt_B12 <- primary_targets("T1", 1, 'B12|b12|obalamin', 'zzz') # value_cutoff modified
