...
syncom <- read.table("/home/moyne/Moyne_disk/Soil_project/Final_datasets/Probiotics_expt_4_06242022/06242022_Probiotics_expt_metaG_count_table.tsv", 
                    sep="\t", 
                    dec=".", 
                    header = TRUE, 
...
colnames(syncom)[3:ncol(syncom)]

colnames(syncom)[3:ncol(syncom)] <- paste(str_split(colnames(syncom)[3:ncol(syncom)], "_", simplify = TRUE)[,1], str_split(colnames(syncom)[3:ncol(syncom)], "_", simplify = TRUE)[,2], str_split(colnames(syncom)[3:ncol(syncom)], "_", simplify = TRUE)[,3], sep = "_")
```
...
```{r, eval = FALSE}
write.table(syncom_no_norm, "/home/moyne/Moyne_disk/Soil_project/Final_datasets/Probiotics_expt_4_06242022/Probiotics_4_Syncom_formatted_filtered_corrected_no_norm.tsv", sep = "\t", col.names = TRUE, row.names = FALSE)
```
...
```{r, eval = FALSE}
write.table(syncom, "/home/moyne/Moyne_disk/Soil_project/Final_datasets/Probiotics_expt_4_06242022/Probiotics_4_Syncom_formatted_filtered_corrected_RPKM.tsv", sep = "\t", col.names = TRUE, row.names = FALSE)
```
