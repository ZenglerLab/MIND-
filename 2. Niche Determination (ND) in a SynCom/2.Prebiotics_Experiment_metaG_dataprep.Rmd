...
syncom <- read.table("/home/moyne/Moyne_disk/Soil_project/Final_datasets/PREBIOTICS_EXP/Prebiotics_SynCom_metaG_count_table.tsv", 
                    sep="\t", 
                    dec=".", 
                    header = TRUE, 
...
Import saf file (contains genomes length)
...
```{r}
# Remove Terrabacter and Bacillus reads (negative controls)
...
```{r, eval = FALSE}
write.table(syncom, "/home/moyne/Moyne_disk/Soil_project/Final_datasets/PREBIOTICS_EXP/Prebiotics_Syncom_metaG_RPKM.tsv", sep = "\t", col.names = TRUE, row.names = FALSE)
```
